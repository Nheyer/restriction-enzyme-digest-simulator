...
# Values are (site, cut_top, cut_bottom); the comment shows NEB notation.
_ENZYME_TABLE: Dict[str, Tuple[str, int, int]] = {
...
ENZYME_DB: Dict[str, Enzyme] = {
    ...
    for name, (site, top, bottom) in _ENZYME_TABLE.items()
}
